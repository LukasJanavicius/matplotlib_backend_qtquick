...
def _setup_pyqt5plus():
    global QtCore, QtGui, QtWidgets, QtQuick, QtQml, __version__, _isdeleted, _getSaveFileName
    ...
    if QT_API == QT_API_PYQT6:
        ...
        QtQuick.QQuickPaintedItem.geometryChanged = QtQuick.QQuickPaintedItem.geometryChange
